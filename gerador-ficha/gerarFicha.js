...
app.post('/receberDados', (req, res) => {        
    ...
    try {
        ...
        const transporter = nodemailer.createTransport({
            ...
            auth: {
              user: EMAIL_USER, // Seu endereço de e-mail
              pass: EMAIL_PASS // Sua da API de email
            }
        });

        const construirEmail = {
            from: EMAIL_USER, // Seu endereço de e-mail
            ...
            attachments: [
            {
                ...
                path: `${saveFichaDirectory}/FichaCatalografica - ${completeName}.docx` // Caminho absoluto do arquivo
            }
            ]
        };
        ...
        setTimeout(() => {
            const diretorioArquivo = `${saveFichaDirectory}/FichaCatalografica - ${completeName}.docx`; // Modificar para o seu
